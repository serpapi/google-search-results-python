...
class TestAsyncYandexSearchApi(unittest.IsolatedAsyncioTestCase):

		def setUp(self):
				AsyncYandexSearch.SERP_API_KEY = os.getenv("API_KEY", "demo")

		@unittest.skipIf((os.getenv("API_KEY") == None), "no api_key provided")
		async def test_get_json(self):
				search = AsyncYandexSearch({"text": "Coffee"})
